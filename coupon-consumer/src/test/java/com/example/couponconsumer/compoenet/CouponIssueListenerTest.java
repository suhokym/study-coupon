...
import com.example.couponconsumer.compoenet.CouponIssueListener;
...
class CouponIssueListenerTest extends TestConfig {
    ...
    void issue_1() throws JacksonException {
        // when
        sut.issue();
        // then
    ...
    void issue_2() throws JacksonException {
        // given
        long couponId = 1;
        long userId = 1;
    ...
    void issue_3() throws JacksonException {
        // given
        long couponId = 1;
        long userId1 = 1;
        long userId2 = 2;
