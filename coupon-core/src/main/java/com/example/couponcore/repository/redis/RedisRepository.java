...
public class RedisRepository {
    ...
    private final String issueReqeustQueueKey = getIssueRequestQueueKey();
    ...
    public void issueRequest(long couponId, long userId, int totalIssueQuntity){
        ...
        try{
            String  code = redisTemplate.execute(
                    issueScript,
                    List.of(issueRequestKey, issueReqeustQueueKey),
                    String.valueOf(userId),
                    String.valueOf(totalIssueQuntity),
            ...
            throw new CouponIssueException(FAIN_COUPON_ISSUE_REQUEST, "input: %s".formatted(couponIssueRequest));
        }
    }
